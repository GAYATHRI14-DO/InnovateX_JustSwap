...
import { Loader2, Globe, Users, ShieldCheck } from "lucide-react";
...
export default function LandingAuthPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background selection:bg-black/10">
        ...
        <div className="w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="flex-1 space-y-8 animate-in fade-in slide-in-from-left duration-1000">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl lg:text-8xl font-script font-bold leading-tight text-foreground">
                Exchange Smart. <br />
                <span className="font-merriweather text-muted-foreground italic">Live Sustainable.</span>
              </h1>
              <p className="text-xl text-muted-foreground max-w-lg leading-relaxed">
                A community-driven platform for bartering items with your neighbors. No money, just pure exchange.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Swap safely with verified community members.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="bg-black/5 p-2 rounded-xl text-foreground">
                ...
                <div>
                  <h3 className="font-bold">Local Loop</h3>
                  <p className="text-sm text-muted-foreground">Keep items circulating within your neighborhood.</p>
                </div>
              </div>
            </div>
          </div>

          {/* Right Side: Auth Gate */}
            ...
            <Card className="rounded-[3rem] border-2 border-black/5 shadow-2xl overflow-hidden bg-white">
              <CardContent className="p-10 text-center space-y-8">
                <div className="space-y-2">
                  <h2 className="text-3xl font-headline font-bold">Start Swapping</h2>
                  <p className="text-muted-foreground">Sign in to access the community</p>
                </div>

                <div className="relative aspect-square w-48 mx-auto rounded-full overflow-hidden border-4 border-black/5 shadow-inner group">
                  {heroImage && (
                    <Image 
      ...
      <footer className="p-8 text-center border-t border-black/5 bg-white/50 backdrop-blur-sm">
