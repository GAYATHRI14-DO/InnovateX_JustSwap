        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <h1 className="text-5xl lg:text-7xl font-script font-bold leading-[1.1] text-foreground">
              Get what you <span className="font-merriweather italic px-1">NEED</span> without money.
            </h1>
          ...
          <div className="mt-16 relative flex justify-center">
            <div className="relative w-full max-w-4xl aspect-[21/9] rounded-3xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-1000 border bg-white">
              {heroImage && (
                <Image 
